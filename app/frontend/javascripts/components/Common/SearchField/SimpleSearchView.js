...
class SimpleSearchView extends LitElement {
  ...
  /** @property {string} _value - value of suggestion or example */
  @state() _value = '';
  ...
  /** Hide suggest, put label in this._value, search by label
   * @private
  ...
  /** Hide suggest, put EXAMPLE value in this._value, search by EXAMPLE value
   * @private
